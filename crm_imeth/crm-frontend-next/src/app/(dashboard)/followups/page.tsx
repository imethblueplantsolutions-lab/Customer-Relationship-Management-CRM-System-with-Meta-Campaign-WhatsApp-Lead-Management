    ...
    <div className="space-y-8 pb-16">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900 tracking-tight flex items-center gap-2.5">
            <Clock className="h-6 w-6 text-[#128c7e]" />
      ...
      {loading ? (
        <div className="py-20 text-center">
          <RefreshCw className="mx-auto h-8 w-8 text-[#128c7e] animate-spin mb-2" />
              ...
              >
                    ...
                    <button
                      ...
                      className={`h-6 w-6 rounded-lg border flex items-center justify-center transition-all cursor-pointer shrink-0 ${
                        f.completed
                          ...
                          : "border-slate-300 hover:border-[#128c7e] bg-white text-transparent"
                      }`}
                    >
                ...
                <div className="pt-2 border-t border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs text-slate-500">
                  <div className="flex items-center gap-4">
                    {f.assignedTo && (
                      <span className="flex items-center gap-1 text-[#128c7e] font-semibold">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 text-xs font-bold text-[#128c7e] hover:text-[#075e54] cursor-pointer"
                  >
