    ...
    <div className="space-y-8">
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-xl bg-[#3282B8] px-4 py-2.5 text-sm font-bold text-white shadow-md hover:bg-[#0F4C75] transition-all cursor-pointer"
        >
          ...
          {flows.map((flow) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <Link
                  href={`/flows/${flow.id}`}
                  className="mt-5 flex w-full items-center justify-center gap-1.5 rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 text-xs font-semibold text-slate-700 hover:bg-white hover:border-[#3282B8] hover:text-[#3282B8] transition-all"
                >
