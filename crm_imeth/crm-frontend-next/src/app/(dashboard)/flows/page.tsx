          ...
          {flows.map((flow) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <Link
                  href={`/flows/${flow.id}`}
                  className="mt-5 flex w-full items-center justify-center gap-1.5 rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 text-xs font-semibold text-slate-700 hover:bg-white hover:border-blue-500 hover:text-blue-600 transition-all"
                >
