...
export default function FlowEditorContent() {
  ...
  // Browser close / navigation warning when dirty
  useEffect(() => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const res = await apiClient(`/flows/${flow.id}/nodes`, {
        method: "PUT",
      ...
      if (res.success) {
        setHasChanges(false);
        toast.success("Flow changes saved successfully!");
      } else {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-120px)]">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-sm font-bold text-slate-800 flex items-center gap-2">
              {flow.name}
              {hasChanges && (
                <span className="inline-flex items-center gap-1 rounded-full bg-amber-50 border border-amber-200/80 px-2 py-0.5 text-[10px] font-semibold text-amber-700">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-200 px-3.5 py-2.5 text-xs text-slate-800 placeholder-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 focus:outline-none"
                    autoFocus
                  />
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full rounded-xl border border-slate-200 p-3 text-xs text-slate-800 placeholder-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 focus:outline-none leading-relaxed"
                    autoFocus
                  />
                  <p className="mt-1.5 text-[11px] text-slate-500 leading-normal">
      ...
      <ConfirmDialog
        ...
        message="You have unsaved changes in this flow. Leaving now will discard your modifications. Do you wish to leave anyway?"
