  ...
  if (isLoading) {
    return (
      <div className="flex h-96 items-center justify-center">
        <RefreshCw className="h-8 w-8 animate-spin text-[#128c7e]" />
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        >
          <RefreshCw className={`h-4 w-4 text-[#128c7e] ${loading ? "animate-spin" : ""}`} />
          Refresh Jobs
        </button>
      </div>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3 bg-white p-4 rounded-2xl border border-slate-200 shadow-xs">
        <div className="relative w-full sm:w-80">
          ...
          <input
            ...
            className="w-full rounded-xl border border-slate-200 bg-slate-50 pl-10 pr-4 py-2 text-xs text-slate-800 placeholder-slate-400 focus:border-[#128c7e] focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#128c7e]/20 transition-all"
          />
        </div>
      ...
      <div className="rounded-2xl border border-slate-200/90 bg-white shadow-xs overflow-hidden">
        {loading && jobs.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 text-center">
            <RefreshCw className="h-8 w-8 animate-spin text-[#128c7e] mb-3" />
                        ...
                        <div className="flex flex-col gap-2">
                          ...
                          <div>
                            <button
                              ...
                              className="inline-flex items-center gap-1 text-[10px] font-bold text-slate-500 hover:text-[#128c7e] transition-colors cursor-pointer"
                            >
                      ...
                      <td className="py-4 px-4 sm:px-6 align-top text-right whitespace-nowrap">
                        <button
                          ...
                          className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold transition-all cursor-pointer shadow-xs ${
                            isFailed
                              ? "bg-[#128c7e] hover:bg-[#075e54] text-white disabled:opacity-50"
