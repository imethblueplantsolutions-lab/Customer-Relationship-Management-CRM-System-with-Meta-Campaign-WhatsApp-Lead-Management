  ...
  if (isLoading) {
    return (
      <div className="flex h-96 items-center justify-center">
        <RefreshCw className="h-8 w-8 animate-spin text-[#3282B8]" />
      </div>
    );
  }
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3 bg-white p-4 rounded-2xl border border-slate-200 shadow-xs">
        <div className="relative w-full sm:w-80">
          ...
          <input
            ...
            className="w-full rounded-xl border border-slate-200 bg-slate-50 pl-10 pr-4 py-2 text-xs text-slate-800 placeholder-slate-400 focus:border-[#3282B8] focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#3282B8]/20 transition-all"
          />
        </div>
      ...
      <div className="rounded-2xl border border-slate-200/90 bg-white shadow-xs overflow-hidden">
        {loading && jobs.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 text-center">
            <RefreshCw className="h-8 w-8 animate-spin text-[#3282B8] mb-3" />
                        ...
                        <div className="flex flex-col gap-2">
                          ...
                          <div>
                            <button
                              ...
                              className="inline-flex items-center gap-1 text-[10px] font-bold text-slate-500 hover:text-[#3282B8] transition-colors cursor-pointer"
                            >
                            ...
                            {isPayloadExpanded && (
                              <div className="mt-2 relative rounded-xl bg-slate-900 p-3 font-mono text-[10px] text-emerald-400 overflow-x-auto shadow-inner">
                                ...
                                >
                                  {copiedId === job.id ? (
                                    <Check className="h-3 w-3 text-[#3282B8]" />
                                  ) : (
                      ...
                      <td className="py-4 px-4 sm:px-6 align-top">
                        {isFailed ? (
                          ...
                          <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-emerald-50 border border-emerald-200 text-emerald-800 font-bold text-[10px]">
                            <CheckCircle2 className="h-3 w-3 text-[#3282B8]" />
                            REPLAYED
                          </span>
                        )}
                      </td>
                      ...
                      <td className="py-4 px-4 sm:px-6 align-top text-right whitespace-nowrap">
                        <button
                          ...
                          className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold transition-all cursor-pointer shadow-xs ${
                            isFailed
                              ? "bg-[#3282B8] hover:bg-[#0F4C75] text-white disabled:opacity-50"
